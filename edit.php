<?php
// ============================================================
// FILE: edit.php (VERSI OOP)
// PENERAPAN KONSEP: OBJECT, CLASS, CONSTRUCTOR, INHERITANCE, ENCAPSULATION
// Halaman untuk mengedit data barang (hanya Admin yang bisa akses)
// ============================================================
...
// INHERITANCE — Cek apakah user bisa edit menggunakan method dari child class
if (!$user->bisaEdit()) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($data['nama_barang']) || empty($data['kategori']) || empty($data['tanggal_masuk'])) {
        ...
        // Memanggil method updateBarang() dari OBJECT $manager
        $hasil = $manager->updateBarang($data); // Memanggil method dari OBJECT
        if ($hasil) {
