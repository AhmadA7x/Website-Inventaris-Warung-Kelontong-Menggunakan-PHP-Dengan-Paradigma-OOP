<?php
// ============================================================
// FILE: tambah.php (VERSI OOP)
// PENERAPAN KONSEP: OBJECT, CLASS, CONSTRUCTOR, ENCAPSULATION
// Halaman untuk menambahkan barang baru ke inventaris
// ============================================================
...
// Proses tambah barang saat form di-submit (method POST)
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($data['nama_barang']) || empty($data['kategori']) || empty($data['tanggal_masuk'])) {
        ...
        // Memanggil method tambahBarang() dari OBJECT $manager
        $hasil = $manager->tambahBarang($data); // Memanggil method dari OBJECT
        if ($hasil) {
